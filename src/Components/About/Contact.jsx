      ...
      <div className="md">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-5 text-xs">
            <input
              ...
              className="w-1 border-b border-gray-400 p-2 focus:outline-none"
            />
            <input
              type="tel"
              name="number"
        ...
        <div className=" flex justify-between items-center py-8 gap-4">
          <div className="flex gap-2">
            <input type="checkbox" />
            <label htmlFor="checkbox" className="text-sm hello">
          ...
          <div>
            <button
              ...
              className="px-8 py-2 md:px-10 md:py-3 bg-primary-yellow hover:bg-yellow-300"
            >
              Send
            </button>
          </div>
